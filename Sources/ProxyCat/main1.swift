...
////  
////
////  Created by xiangyue on 2023/1/5.
////
//
//import NIOCore
//import NIOPosix
...
//import ProxyCatCore
//
//CertificateUtil().signCertificate(forHost: "*.apple.com")
//
...
//                        }
//                    )
//        return channel.pipeline.addHandlers(sslServerHandler).flatMap {
//            return channel.pipeline.configureHTTPServerPipeline(withServerUpgrade: nil).flatMap {
